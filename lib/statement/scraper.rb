...
module Statement
  class Scraper
    ...
    def self.member_methods
      ...
      :bennie_thompson, :speier, :poe, :grassley, :bennet, :shaheen, :sanford, :butterfield, :brady, :keating]
    end
    ...
    def self.member_scrapers
      ...
      results = [crenshaw, capuano, cold_fusion(year, nil), conaway, chabot, klobuchar(year), palazzo(page=1), roe(page=1), billnelson(page=0),
        ...
        poe(year=year, month=0), bennet(page=1), shaheen(page=1), sanford(page=0), perlmutter, butterfield, brady, keating].flatten
